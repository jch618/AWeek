...
#include UE_INLINE_GENERATED_CPP_BY_NAME(SAWeekCrossHairMarkerWidget)

class FPaintArgs;
class FSlateRect;

SAWeekCrossHairMarkerWidget::SAWeekCrossHairMarkerWidget()
{
}

void SAWeekCrossHairMarkerWidget::Construct(const FArguments& InArgs)
{
...
int32 SAWeekCrossHairMarkerWidget::OnPaint(const FPaintArgs& Args, const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FWidgetStyle& InWidgetStyle, bool bParentEnabled) const
{
...
FVector2D SAWeekCrossHairMarkerWidget::ComputeDesiredSize(float) const
{
	check(MarkerBrush);
...
void SAWeekCrossHairMarkerWidget::SetRadius(float NewRadius)
{
...
void SAWeekCrossHairMarkerWidget::SetMarkerList(TArray<FCircumferenceMarkerEntry>& NewMarkerList)
{
